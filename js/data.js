export const questions = [
    ...
    {
        number: '08',
        question: '눈 앞에 BMW E92 M3가 있습니다.<br>무슨 생각이 드시나요?',
        choices: [
            { text: '4세대 M3군...<br>4.0리터 S65엔진, 414마력, 400Nm...', value: 's' },
            { text: '와! 마지막 자연흡기 v8 M3!<br>배기음 죽여주겠지? 차주는 어떤 사람일까?', value: 'n' }
        ]
    },
    {
        number: '09',
...
export const results = [
    {
        ...
        carimage: '/MBTI/images/result_character1.png',
        car: '테슬라 모델S 플래드',
        options: '요크핸들, FSD, 팔콘윙도어, 디지털 사이드미러... 기타등등 수만가지 최신 옵션',
        results:
    ...
    },
    {
        ...
        results:
          '온화한 성격을 지닌 당신~<br>\
          깜빡이를 안 킨 앞차가 칼치기로 들어와도 속으로 욕하고 그러려니 넘어가요~<br>\
          뒷좌석 승객들의 요구를 잘들어줘요. 그런데 프라이버시를 중요시 여겨서 트렁크 속을 보여주진 않을거 같아요~<br>\
          은근히 우유부단해서 차의 색상은 왠지 흰색일 것 같아요~',
        passangers: ['ESFP', 'ISFJ']
    },
    {
        // mbti: 'ESTJ',
    ...
    },
    {
        ...
        options: '칼같은 핸들링',
        results:
          '갑작스러운 변화를 싫어하고 원리 원칙적이라 예상이 가능한 움직임을 보여주는 차를 좋아해요.<br>\
          남들이 나의 차에 뭐라고 하는건 싫어하지만 은근히 내 차에 대해 잘난체를 해요.<br>\
          도로에서 방향지시등을 켜지 않거나 스텔스 차들을 보면 화가 치밀어 오르지만 속으로만 욕해요.<br>\
          운전하다가 실수하면 누구보다 빠르게 비상등을 켜요.',
        passangers: ['ESFP', 'INFP']
    },
    {
        // mbti: 'ESFJ',
    ...
    },
    {
        ...
        options: '남들과는 다른 스타일',
        results:
          '독립적인 성격이라 독창적인 아이디어를 내는 당신!<br>\
          차를 고를때 꽃힌 구석이 있으면 남들의 시선따윈 신경쓰지 않고 바로 계약해버려요.<br>\
          아! 물론 공식홈페이지, 제원표, 시승기, 유튜브 모두 찾아보고 결정한답니다.<br>\
          일관성 있는 성격이라 차에 쓰레기라는건 존재하지 않고 항상 깨끗해요.',
        passangers: ['ENFP', 'ISFJ']
    },
    {
        // mbti: 'ENTP',
    ...
    },
    {
        ...
        carimage: '/MBTI/images/result_character1.png',
        car: '닛산 GT-R 니스모',
        options: '제로백, 랩타임, 기타등등 수치들을 보여주는 온보드 컴퓨터, 조절식 서스펜션',
        results:
    ...
    },
    {
        ...
        results:
          '사회현상, 환경에 관심이 많아서 재활용 소재를 많이 쓴 전기차로 일찍이 바꿨어요.<br>\
          배려심이 많아 양보운전을 실천해요. 하지만 난폭운전을 보면 스마트국민제보로 바로 신고넣어요.<br>\
          지인이 난폭운전을 당했을 때 내가 더 분해서 대신 화내줘요.<br>\
          그래서 오지랖 넓다는 소리를 종종 듣는답니다.',
        passangers: ['INFP', 'ESFJ']
    },
    {
        // mbti: 'INFJ',
    ...
    },
    {
        ...
        results:
          '남다르게 흥이 넘치는 당신! 여행길이든 출퇴근길이든 음악이 없는 드라이브는 상상할 수 없어요.<br>\
          휴지를 찾으려고 글로브 박스를 열어보면 블루투스 마이크가 덩그러니 있어요.<br>\
          두루두루 잘 지내는게 좋다고 생각해 서먹서먹한 사람이 태워달라고 하면 거절을 못하는 편이에요.<br>\
          하지만 생색은 조금 내는 편이랍니다.',
        passangers: ['ISFP', 'ESTJ']
    },
    {
        // mbti: 'INFP',
        ...
        options: '2인승, 희소성',
        results:
          '차를 구매할때 남들의 의견보다 나만의 확고한 기준을 따라 구매해요. 또, 남에게 간섭도 잘 하지 않아요.<br>\
          차 안에도 남들은 이해 못하지만 내가 아끼는 나만의 액세서리가 하나쯤 있어요.<br>\
          독고다이이지만 너그러워서 동승자가 차에 타서 이것저것 만져도 크게 나무라지 않아요.<br>\
          하지만 얌체운전자를 만나면 속으로 궁시렁궁시렁 대는 스타일이에요.',
        passangers: ['ENFJ', 'ESTP']
    },
]
export const mbtis = {
    ESTP: 0,
